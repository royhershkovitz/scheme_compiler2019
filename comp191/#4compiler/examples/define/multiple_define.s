...
love:
    ...
    mov qword [fvar_tbl + WORD_SIZE*39], rax;setting fvar:x
...
push SOB_NIL_ADDRESS
    ...
    push rax
			mov rax, [fvar_tbl + WORD_SIZE*39];get fvar:x
		IS_UNDEF
    push rax
    push qword 2
    ...
    ret
		doneclousure1:
    mov qword [fvar_tbl + WORD_SIZE*38], rax;setting fvar:z
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    push rax
    push qword 1
    mov rax, [fvar_tbl + WORD_SIZE*38];get fvar:z
		IS_UNDEF
    violation_check rax, T_CLOSURE
    rest_applic
		call write_sob_if_not_void
...
push SOB_NIL_ADDRESS
    ...
    ret
		doneclousure2:
    mov qword [fvar_tbl + WORD_SIZE*37], rax;setting fvar:w
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void

		push SOB_NIL_ADDRESS
    push qword 0
    mov rax, [fvar_tbl + WORD_SIZE*37];get fvar:w
		IS_UNDEF
    violation_check rax, T_CLOSURE
    rest_applic
		call write_sob_if_not_void
