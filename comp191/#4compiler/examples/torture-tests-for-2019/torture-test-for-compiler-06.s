...
db 111,100,100,45,50
	MAKE_LITERAL_SYMBOL (const_tbl+178)
	MAKE_LITERAL_STRING (5)
db 111,100,100,45,53
	MAKE_LITERAL_SYMBOL (const_tbl+201)
	MAKE_LITERAL_STRING (7)
db 111,100,100,101,114,45,53
	MAKE_LITERAL_SYMBOL (const_tbl+224)
...
love:
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*48], rax;setting fvar:append
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void

		
    push SOB_NIL_ADDRESS
			mov rax, qword [fvar_tbl + WORD_SIZE*48];get fvar:append
		IS_UNDEF sym48
    push rax
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*49], rax;setting fvar:reverse
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    push rax
		...
		IS_UNDEF sym48
    push rax
			mov rax, qword [fvar_tbl + WORD_SIZE*49];get fvar:reverse
		IS_UNDEF sym49
    push rax
			mov rax, qword [fvar_tbl + WORD_SIZE*11];get fvar:null?
		IS_UNDEF sym11
    ...
    push rax
		...
		IS_UNDEF sym2
    push rax
			mov rax, qword [fvar_tbl + WORD_SIZE*38];get fvar:not
		IS_UNDEF sym38
    push rax
			mov rax, qword [fvar_tbl + WORD_SIZE*34];get fvar:=
		IS_UNDEF sym34
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*35], rax;setting fvar:positive?
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*39], rax;setting fvar:negative?
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    push rax
    push qword 2
    mov rax, qword [fvar_tbl + WORD_SIZE*37];get fvar:equal?
		IS_UNDEF sym37
    violation_check rax, T_CLOSURE
      REST_APPLIC
    cmp rax, SOB_FALSE_ADDRESS
    ...
    push SOB_NIL_ADDRESS
			mov rax, PVAR(0);get param:even-1?
    push rax
    push qword 1
    mov rax, qword [fvar_tbl + WORD_SIZE*51];get fvar:box
		IS_UNDEF sym51
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov PVAR(0), rax;setting param:even-1?
    mov rax, SOB_VOID_ADDRESS
		
    push SOB_NIL_ADDRESS
			mov rax, PVAR(1);get param:odd-2?
    push rax
    push qword 1
    mov rax, qword [fvar_tbl + WORD_SIZE*51];get fvar:box
		IS_UNDEF sym51
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov PVAR(1), rax;setting param:odd-2?
    mov rax, SOB_VOID_ADDRESS
		
    push SOB_NIL_ADDRESS
			mov rax, PVAR(2);get param:even-3?
    push rax
    push qword 1
    mov rax, qword [fvar_tbl + WORD_SIZE*51];get fvar:box
		IS_UNDEF sym51
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov PVAR(2), rax;setting param:even-3?
    mov rax, SOB_VOID_ADDRESS
		
    push SOB_NIL_ADDRESS
			mov rax, PVAR(3);get param:odd-5?
    push rax
    push qword 1
    mov rax, qword [fvar_tbl + WORD_SIZE*51];get fvar:box
		IS_UNDEF sym51
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov PVAR(3), rax;setting param:odd-5?
    mov rax, SOB_VOID_ADDRESS
		push SOB_NIL_ADDRESS
			EXTEND_VEC rax, rbx
    push rax
    ...
    push SOB_NIL_ADDRESS
			GET_BOUND rax,0,1;get bound:odd-2?
    push rax
    push qword 1
    mov rax, qword [fvar_tbl + WORD_SIZE*2];get fvar:car
		IS_UNDEF sym2
    ...
    push rax
    push qword 1
    mov rax, qword [fvar_tbl + WORD_SIZE*35];get fvar:positive?
		IS_UNDEF sym35
    violation_check rax, T_CLOSURE
      REST_APPLIC
    cmp rax, SOB_FALSE_ADDRESS
    ...
    push SOB_NIL_ADDRESS
			GET_BOUND rax,0,2;get bound:even-3?
    push rax
    push qword 1
    mov rax, qword [fvar_tbl + WORD_SIZE*2];get fvar:car
		IS_UNDEF sym2
    ...
    push SOB_NIL_ADDRESS
			GET_BOUND rax,0,3;get bound:odd-5?
    push rax
    push qword 1
    mov rax, qword [fvar_tbl + WORD_SIZE*2];get fvar:car
		IS_UNDEF sym2
    ...
    push SOB_NIL_ADDRESS
			GET_BOUND rax,0,0;get bound:even-1?
    push rax
    push qword 1
    mov rax, qword [fvar_tbl + WORD_SIZE*2];get fvar:car
		IS_UNDEF sym2
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*0], rax;setting fvar:even?
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    push rax
    push qword 1
    mov rax, qword [fvar_tbl + WORD_SIZE*0];get fvar:even?
		IS_UNDEF sym0
    violation_check rax, T_CLOSURE
      REST_APPLIC
		call write_sob_if_not_void
