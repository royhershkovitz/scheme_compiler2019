...
db 121,111,115,105
	...
	MAKE_LITERAL_STRING (4)
db 100,97,110,97
	MAKE_LITERAL_SYMBOL (const_tbl+223)
	MAKE_LITERAL_STRING (6)
db 109,105,99,104,97,108
	MAKE_LITERAL_SYMBOL (const_tbl+245)
	MAKE_LITERAL_STRING (4)
db 111,108,103,97
	MAKE_LITERAL_SYMBOL (const_tbl+269)
	MAKE_LITERAL_STRING (5)
db 115,111,110,105,97
	MAKE_LITERAL_SYMBOL (const_tbl+291)
	MAKE_LITERAL_INT (10)
fvar_tbl:
  dq T_UNDEFINED
	dq T_UNDEFINED
...
love:
    ...
    ret
		doneclousure1:
    mov qword [fvar_tbl + WORD_SIZE*52], rax;setting fvar:set-box!
    ...
    ret
		doneclousure2:
    mov qword [fvar_tbl + WORD_SIZE*51], rax;setting fvar:unbox
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    ret
		doneclousure3:
    mov qword [fvar_tbl + WORD_SIZE*50], rax;setting fvar:box
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    push rax
    push qword 1
    mov rax, qword [fvar_tbl + WORD_SIZE*50];get fvar:box
		IS_UNDEF sym50
    violation_check rax, T_CLOSURE
      REST_APPLIC
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*35], rax;setting fvar:zero?
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    mov rax, qword [fvar_tbl + WORD_SIZE*46];get fvar:list?
		IS_UNDEF sym46
    violation_check rax, T_CLOSURE
    TP_SHIFT_FRAME 1
    REST_APPLICTP
    ...
    push SOB_NIL_ADDRESS
			mov rax, qword [fvar_tbl + WORD_SIZE*40];get fvar:length
		IS_UNDEF sym40
    push rax
			mov rax, qword [fvar_tbl + WORD_SIZE*33];get fvar:=
		IS_UNDEF sym33
    ...
    push rax
    push qword 2
    mov rax, qword [fvar_tbl + WORD_SIZE*44];get fvar:map
		IS_UNDEF sym44
    violation_check rax, T_CLOSURE
      REST_APPLIC
    push rax
    ...
    push SOB_NIL_ADDRESS
			mov rax, qword [fvar_tbl + WORD_SIZE*42];get fvar:list->vector
		IS_UNDEF sym42
    push rax
    push qword 1
    EXTEND_VEC rax, rbx
    ...
    ret
		doneclousure83:
    mov qword [fvar_tbl + WORD_SIZE*36], rax;setting fvar:with
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    push SOB_NIL_ADDRESS
			mov rax, PVAR(0);get param:fact-1
    push rax
    push qword 1
    mov rax, qword [fvar_tbl + WORD_SIZE*50];get fvar:box
		IS_UNDEF sym50
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov PVAR(0), rax;setting param:fact-1
    mov rax, SOB_VOID_ADDRESS
		
    push SOB_NIL_ADDRESS
			mov rax, PVAR(1);get param:fact-2
    push rax
    push qword 1
    mov rax, qword [fvar_tbl + WORD_SIZE*50];get fvar:box
		IS_UNDEF sym50
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov PVAR(1), rax;setting param:fact-2
    mov rax, SOB_VOID_ADDRESS
		
    push SOB_NIL_ADDRESS
			mov rax, PVAR(2);get param:fact-3
    push rax
    push qword 1
    mov rax, qword [fvar_tbl + WORD_SIZE*50];get fvar:box
		IS_UNDEF sym50
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov PVAR(2), rax;setting param:fact-3
    mov rax, SOB_VOID_ADDRESS
		push SOB_NIL_ADDRESS
			EXTEND_VEC rax, rbx
    push rax
    ...
    push rax
    push qword 1
    mov rax, qword [fvar_tbl + WORD_SIZE*35];get fvar:zero?
		IS_UNDEF sym35
    violation_check rax, T_CLOSURE
      REST_APPLIC
    cmp rax, SOB_FALSE_ADDRESS
    je dif51
    mov rax, PVAR(1);get param:r
    jmp doneif51
    dif51:
    push SOB_NIL_ADDRESS
    ...
    push SOB_NIL_ADDRESS
			GET_BOUND rax,0,1;get bound:fact-2
    push rax
    push qword 1
    mov rax, qword [fvar_tbl + WORD_SIZE*1];get fvar:car
		IS_UNDEF sym1
    ...
    push SOB_NIL_ADDRESS
			GET_BOUND rax,0,2;get bound:fact-3
    push rax
    push qword 1
    mov rax, qword [fvar_tbl + WORD_SIZE*1];get fvar:car
		IS_UNDEF sym1
    ...
    push SOB_NIL_ADDRESS
			GET_BOUND rax,0,0;get bound:fact-1
    push rax
    push qword 1
    mov rax, qword [fvar_tbl + WORD_SIZE*1];get fvar:car
		IS_UNDEF sym1
    ...
    leave
    ret
		doneclousure88:;seq ret;seq ret
    leave
    ret
		doneclousure84:
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*34], rax;setting fvar:fact
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void

		push SOB_NIL_ADDRESS
			mov rax, const_tbl + 314
    push rax
    push qword 1
    mov rax, qword [fvar_tbl + WORD_SIZE*34];get fvar:fact
		IS_UNDEF sym34
    violation_check rax, T_CLOSURE
      REST_APPLIC
		call write_sob_if_not_void
