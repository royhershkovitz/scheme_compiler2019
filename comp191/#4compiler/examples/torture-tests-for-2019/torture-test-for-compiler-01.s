...
love:
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*34], rax;setting fvar:zero?
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    mov rax, qword [fvar_tbl + WORD_SIZE*44];get fvar:list?
		IS_UNDEF sym44
    violation_check rax, T_CLOSURE
    TP_SHIFT_FRAME 1
    REST_APPLICTP
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*38], rax;setting fvar:length
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void

		
    push SOB_NIL_ADDRESS
			mov rax, qword [fvar_tbl + WORD_SIZE*38];get fvar:length
		IS_UNDEF sym38
    push rax
			mov rax, qword [fvar_tbl + WORD_SIZE*33];get fvar:=
		IS_UNDEF sym33
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*43], rax;setting fvar:number?
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    push rax
    push qword 2
    mov rax, qword [fvar_tbl + WORD_SIZE*42];get fvar:map
		IS_UNDEF sym42
    violation_check rax, T_CLOSURE
      REST_APPLIC
    push rax
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*42], rax;setting fvar:map
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*40], rax;setting fvar:list->vector
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*41], rax;setting fvar:vector->list
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void

		
    push SOB_NIL_ADDRESS
			mov rax, qword [fvar_tbl + WORD_SIZE*40];get fvar:list->vector
		IS_UNDEF sym40
    push rax
    push qword 1
    EXTEND_VEC rax, rbx
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*39], rax;setting fvar:vector
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*37], rax;setting fvar:>
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    LAMBDA_ARG_CHECK 2
    push SOB_NIL_ADDRESS
			mov rax, PVAR(1);get param:n
    push rax
    push qword 1
    mov rax, qword [fvar_tbl + WORD_SIZE*34];get fvar:zero?
		IS_UNDEF sym34
    violation_check rax, T_CLOSURE
      REST_APPLIC
    cmp rax, SOB_FALSE_ADDRESS
