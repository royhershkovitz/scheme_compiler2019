...
symbols_tbl:
  sym0:
    ...
    db 61, 0
	sym35:
    db 99,114,97,122,121,45,97,99,107, 0
	sym36:
...
love:
    ...
    ret
		doneclousure1:
    mov qword [fvar_tbl + WORD_SIZE*55], rax;setting fvar:set-box!
    ...
    ret
		doneclousure2:
    mov qword [fvar_tbl + WORD_SIZE*54], rax;setting fvar:unbox
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    ret
		doneclousure3:
    mov qword [fvar_tbl + WORD_SIZE*53], rax;setting fvar:box
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    ret
		doneclousure4:
    mov qword [fvar_tbl + WORD_SIZE*52], rax;setting fvar:list
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    push rax
    push qword 1
    mov rax, qword [fvar_tbl + WORD_SIZE*53];get fvar:box
		IS_UNDEF sym53
    violation_check rax, T_CLOSURE
      REST_APPLIC
    ...
    push SOB_NIL_ADDRESS
		...
		IS_UNDEF sym50
    push rax
			mov rax, qword [fvar_tbl + WORD_SIZE*52];get fvar:list
		IS_UNDEF sym52
    push rax
			mov rax, qword [fvar_tbl + WORD_SIZE*3];get fvar:cdr
		IS_UNDEF sym3
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*37], rax;setting fvar:zero?
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*39], rax;setting fvar:not
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    push rax
		...
		IS_UNDEF sym2
    push rax
			mov rax, qword [fvar_tbl + WORD_SIZE*39];get fvar:not
		IS_UNDEF sym39
    push rax
			mov rax, qword [fvar_tbl + WORD_SIZE*34];get fvar:=
		IS_UNDEF sym34
    ...
    push SOB_NIL_ADDRESS
			mov rax, qword [fvar_tbl + WORD_SIZE*42];get fvar:>
		IS_UNDEF sym42
    push rax
    push qword 1
    EXTEND_VEC rax, rbx
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*41], rax;setting fvar:positive?
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*40], rax;setting fvar:negative?
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    push rax
    push qword 2
    mov rax, qword [fvar_tbl + WORD_SIZE*38];get fvar:equal?
		IS_UNDEF sym38
    violation_check rax, T_CLOSURE
      REST_APPLIC
    cmp rax, SOB_FALSE_ADDRESS
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*38], rax;setting fvar:equal?
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov PVAR(0), rax;setting param:ack3
    mov rax, SOB_VOID_ADDRESS
		
    push SOB_NIL_ADDRESS
			mov rax, PVAR(1);get param:ack-x
    push rax
    push qword 1
    mov rax, qword [fvar_tbl + WORD_SIZE*53];get fvar:box
		IS_UNDEF sym53
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov PVAR(1), rax;setting param:ack-x
    mov rax, SOB_VOID_ADDRESS
		
    push SOB_NIL_ADDRESS
			mov rax, PVAR(2);get param:ack-y
    push rax
    push qword 1
    mov rax, qword [fvar_tbl + WORD_SIZE*53];get fvar:box
		IS_UNDEF sym53
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov PVAR(2), rax;setting param:ack-y
    mov rax, SOB_VOID_ADDRESS
		
    push SOB_NIL_ADDRESS
			mov rax, PVAR(3);get param:ack-z
    push rax
    push qword 1
    mov rax, qword [fvar_tbl + WORD_SIZE*53];get fvar:box
		IS_UNDEF sym53
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov PVAR(3), rax;setting param:ack-z
    mov rax, SOB_VOID_ADDRESS
		push SOB_NIL_ADDRESS
			EXTEND_VEC rax, rbx
    push rax
    ...
    LAMBDA_ARG_CHECK 3
    push SOB_NIL_ADDRESS
			mov rax, PVAR(0);get param:a
    push rax
    push qword 1
    mov rax, qword [fvar_tbl + WORD_SIZE*37];get fvar:zero?
		IS_UNDEF sym37
    violation_check rax, T_CLOSURE
      REST_APPLIC
    cmp rax, SOB_FALSE_ADDRESS
    ...
    push SOB_NIL_ADDRESS
			GET_BOUND rax,0,1;get bound:ack-x
    push rax
    push qword 1
    mov rax, qword [fvar_tbl + WORD_SIZE*2];get fvar:car
		IS_UNDEF sym2
    ...
    push qword 3
    push SOB_NIL_ADDRESS
			GET_BOUND rax,0,2;get bound:ack-y
    push rax
    push qword 1
    mov rax, qword [fvar_tbl + WORD_SIZE*2];get fvar:car
		IS_UNDEF sym2
    ...
    push SOB_NIL_ADDRESS
			GET_BOUND rax,0,3;get bound:ack-z
    push rax
    push qword 1
    mov rax, qword [fvar_tbl + WORD_SIZE*2];get fvar:car
		IS_UNDEF sym2
    ...
    LAMBDA_ARG_CHECK 2
    push SOB_NIL_ADDRESS
			mov rax, PVAR(1);get param:c
    push rax
			mov rax, PVAR(0);get param:b
    push rax
			GET_BOUND rax,0,0;get bound:a
    push rax
    
    push SOB_NIL_ADDRESS
			GET_BOUND rax,1,0;get bound:ack3
    push rax
    push qword 1
    mov rax, qword [fvar_tbl + WORD_SIZE*2];get fvar:car
		IS_UNDEF sym2
    ...
    ret
		doneclousure91:
    push rax
			mov rax, PVAR(1);get param:bcs
    push rax
    
    mov rax, qword [fvar_tbl + WORD_SIZE*36];get fvar:with
		IS_UNDEF sym36
    violation_check rax, T_CLOSURE
    TP_SHIFT_FRAME 2
    REST_APPLICTP
    ...
    LAMBDA_ARG_CHECK 1
    push SOB_NIL_ADDRESS
			mov rax, PVAR(0);get param:c
    push rax
			GET_BOUND rax,0,1;get bound:b
    push rax
			GET_BOUND rax,0,0;get bound:a
    push rax
    ...
    push qword 3
    push SOB_NIL_ADDRESS
			GET_BOUND rax,0,0;get bound:ack3
    push rax
    push qword 1
    mov rax, qword [fvar_tbl + WORD_SIZE*2];get fvar:car
		IS_UNDEF sym2
    ...
    leave
    ret
		doneclousure96:;seq ret;seq ret
    leave
    ret
		doneclousure88:
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*35], rax;setting fvar:crazy-ack
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void

		push SOB_NIL_ADDRESS
    push qword 0
    mov rax, qword [fvar_tbl + WORD_SIZE*35];get fvar:crazy-ack
		IS_UNDEF sym35
    violation_check rax, T_CLOSURE
      REST_APPLIC
		call write_sob_if_not_void
