...
love:
    ...
    ret
		doneclousure1:
    mov qword [fvar_tbl + WORD_SIZE*50], rax;setting fvar:set-box!
    ...
    ret
		doneclousure2:
    mov qword [fvar_tbl + WORD_SIZE*49], rax;setting fvar:unbox
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    ret
		doneclousure3:
    mov qword [fvar_tbl + WORD_SIZE*48], rax;setting fvar:box
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    push rax
    push qword 1
    mov rax, qword [fvar_tbl + WORD_SIZE*48];get fvar:box
		IS_UNDEF sym48
    violation_check rax, T_CLOSURE
      REST_APPLIC
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*45], rax;setting fvar:append
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void

		
    push SOB_NIL_ADDRESS
			mov rax, qword [fvar_tbl + WORD_SIZE*45];get fvar:append
		IS_UNDEF sym45
    push rax
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*46], rax;setting fvar:reverse
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    push rax
		...
		IS_UNDEF sym45
    push rax
			mov rax, qword [fvar_tbl + WORD_SIZE*46];get fvar:reverse
		IS_UNDEF sym46
    push rax
			mov rax, qword [fvar_tbl + WORD_SIZE*10];get fvar:null?
		IS_UNDEF sym10
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*44], rax;setting fvar:zero?
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    mov rax, qword [fvar_tbl + WORD_SIZE*43];get fvar:list?
		IS_UNDEF sym43
    violation_check rax, T_CLOSURE
    TP_SHIFT_FRAME 1
    REST_APPLICTP
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*43], rax;setting fvar:list?
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*37], rax;setting fvar:length
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void

		
    push SOB_NIL_ADDRESS
			mov rax, qword [fvar_tbl + WORD_SIZE*37];get fvar:length
		IS_UNDEF sym37
    push rax
			mov rax, qword [fvar_tbl + WORD_SIZE*33];get fvar:=
		IS_UNDEF sym33
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*35], rax;setting fvar:not
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*42], rax;setting fvar:number?
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    push rax
    push qword 2
    mov rax, qword [fvar_tbl + WORD_SIZE*41];get fvar:map
		IS_UNDEF sym41
    violation_check rax, T_CLOSURE
      REST_APPLIC
    push rax
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*41], rax;setting fvar:map
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*39], rax;setting fvar:list->vector
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*40], rax;setting fvar:vector->list
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void

		
    push SOB_NIL_ADDRESS
			mov rax, qword [fvar_tbl + WORD_SIZE*39];get fvar:list->vector
		IS_UNDEF sym39
    push rax
    push qword 1
    EXTEND_VEC rax, rbx
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*38], rax;setting fvar:vector
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    push rax
		...
		IS_UNDEF sym1
    push rax
			mov rax, qword [fvar_tbl + WORD_SIZE*35];get fvar:not
		IS_UNDEF sym35
    push rax
			mov rax, qword [fvar_tbl + WORD_SIZE*33];get fvar:=
		IS_UNDEF sym33
    ...
    push rax
    push qword 2
    mov rax, qword [fvar_tbl + WORD_SIZE*34];get fvar:equal?
		IS_UNDEF sym34
    violation_check rax, T_CLOSURE
      REST_APPLIC
    cmp rax, SOB_FALSE_ADDRESS
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*34], rax;setting fvar:equal?
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody213)
		jmp doneclousure213
		lambody213:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody214)
		jmp doneclousure214
		lambody214:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody211)
		jmp doneclousure211
		lambody211:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody212)
		jmp doneclousure212
		lambody212:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody209)
		jmp doneclousure209
		lambody209:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody210)
		jmp doneclousure210
		lambody210:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody207)
		jmp doneclousure207
		lambody207:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody208)
		jmp doneclousure208
		lambody208:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody198)
		jmp doneclousure198
		lambody198:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody199)
		jmp doneclousure199
		lambody199:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody205)
		jmp doneclousure205
		lambody205:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody206)
		jmp doneclousure206
		lambody206:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody200)
		jmp doneclousure200
		lambody200:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody201)
		jmp doneclousure201
		lambody201:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody202)
		jmp doneclousure202
		lambody202:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody203)
		jmp doneclousure203
		lambody203:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody204)
		jmp doneclousure204
		lambody204:
		push rbp
    mov rbp, rsp
    ...
    push qword 1
    push SOB_NIL_ADDRESS
			GET_BOUND rax,0,0;get bound:s
    push rax
    push qword 1
    GET_BOUND rax,1,0;get bound:n
    violation_check rax, T_CLOSURE
      REST_APPLIC
    violation_check rax, T_CLOSURE
      REST_APPLIC
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody189)
		jmp doneclousure189
		lambody189:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody190)
		jmp doneclousure190
		lambody190:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody196)
		jmp doneclousure196
		lambody196:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody197)
		jmp doneclousure197
		lambody197:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody191)
		jmp doneclousure191
		lambody191:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody192)
		jmp doneclousure192
		lambody192:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody193)
		jmp doneclousure193
		lambody193:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody194)
		jmp doneclousure194
		lambody194:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody195)
		jmp doneclousure195
		lambody195:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody187)
		jmp doneclousure187
		lambody187:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody188)
		jmp doneclousure188
		lambody188:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody153)
		jmp doneclousure153
		lambody153:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody186)
		jmp doneclousure186
		lambody186:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody185)
		jmp doneclousure185
		lambody185:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody182)
		jmp doneclousure182
		lambody182:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody183)
		jmp doneclousure183
		lambody183:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody184)
		jmp doneclousure184
		lambody184:
		push rbp
    mov rbp, rsp
    LAMBDA_ARG_CHECK 1
    push SOB_NIL_ADDRESS
			GET_BOUND rax,0,0;get bound:b
    push rax
    
    push SOB_NIL_ADDRESS
			GET_BOUND rax,1,0;get bound:a
    push rax
    push qword 1
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody157)
		jmp doneclousure157
		lambody157:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody179)
		jmp doneclousure179
		lambody179:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody180)
		jmp doneclousure180
		lambody180:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody181)
		jmp doneclousure181
		lambody181:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody176)
		jmp doneclousure176
		lambody176:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody177)
		jmp doneclousure177
		lambody177:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody178)
		jmp doneclousure178
		lambody178:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody167)
		jmp doneclousure167
		lambody167:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody168)
		jmp doneclousure168
		lambody168:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody174)
		jmp doneclousure174
		lambody174:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody175)
		jmp doneclousure175
		lambody175:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody169)
		jmp doneclousure169
		lambody169:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody170)
		jmp doneclousure170
		lambody170:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody171)
		jmp doneclousure171
		lambody171:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody172)
		jmp doneclousure172
		lambody172:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody173)
		jmp doneclousure173
		lambody173:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody164)
		jmp doneclousure164
		lambody164:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody165)
		jmp doneclousure165
		lambody165:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody166)
		jmp doneclousure166
		lambody166:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody161)
		jmp doneclousure161
		lambody161:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody162)
		jmp doneclousure162
		lambody162:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody163)
		jmp doneclousure163
		lambody163:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody158)
		jmp doneclousure158
		lambody158:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody159)
		jmp doneclousure159
		lambody159:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody160)
		jmp doneclousure160
		lambody160:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody154)
		jmp doneclousure154
		lambody154:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody155)
		jmp doneclousure155
		lambody155:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody156)
		jmp doneclousure156
		lambody156:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody127)
		jmp doneclousure127
		lambody127:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody128)
		jmp doneclousure128
		lambody128:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody129)
		jmp doneclousure129
		lambody129:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody151)
		jmp doneclousure151
		lambody151:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody152)
		jmp doneclousure152
		lambody152:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody149)
		jmp doneclousure149
		lambody149:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody150)
		jmp doneclousure150
		lambody150:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody146)
		jmp doneclousure146
		lambody146:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody147)
		jmp doneclousure147
		lambody147:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody148)
		jmp doneclousure148
		lambody148:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody133)
		jmp doneclousure133
		lambody133:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody143)
		jmp doneclousure143
		lambody143:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody144)
		jmp doneclousure144
		lambody144:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody145)
		jmp doneclousure145
		lambody145:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody140)
		jmp doneclousure140
		lambody140:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody141)
		jmp doneclousure141
		lambody141:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody142)
		jmp doneclousure142
		lambody142:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody137)
		jmp doneclousure137
		lambody137:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody138)
		jmp doneclousure138
		lambody138:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody139)
		jmp doneclousure139
		lambody139:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody134)
		jmp doneclousure134
		lambody134:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody135)
		jmp doneclousure135
		lambody135:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody136)
		jmp doneclousure136
		lambody136:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody130)
		jmp doneclousure130
		lambody130:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody131)
		jmp doneclousure131
		lambody131:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody132)
		jmp doneclousure132
		lambody132:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody121)
		jmp doneclousure121
		lambody121:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody125)
		jmp doneclousure125
		lambody125:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody126)
		jmp doneclousure126
		lambody126:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody122)
		jmp doneclousure122
		lambody122:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody123)
		jmp doneclousure123
		lambody123:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody124)
		jmp doneclousure124
		lambody124:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody119)
		jmp doneclousure119
		lambody119:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody120)
		jmp doneclousure120
		lambody120:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody117)
		jmp doneclousure117
		lambody117:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody118)
		jmp doneclousure118
		lambody118:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody114)
		jmp doneclousure114
		lambody114:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody115)
		jmp doneclousure115
		lambody115:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody116)
		jmp doneclousure116
		lambody116:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody111)
		jmp doneclousure111
		lambody111:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody112)
		jmp doneclousure112
		lambody112:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody113)
		jmp doneclousure113
		lambody113:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody108)
		jmp doneclousure108
		lambody108:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody109)
		jmp doneclousure109
		lambody109:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody110)
		jmp doneclousure110
		lambody110:
		push rbp
    mov rbp, rsp
    ...
    COPY_PARAM rbx
		mov rbx, rax
		MAKE_CLOSURE(rax, rbx, lambody107)
		jmp doneclousure107
		lambody107:
		push rbp
    mov rbp, rsp
