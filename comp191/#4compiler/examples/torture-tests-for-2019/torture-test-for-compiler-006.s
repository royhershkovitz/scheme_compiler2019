...
db 97
	...
	MAKE_LITERAL_STRING (1)
db 98
	MAKE_LITERAL_SYMBOL (const_tbl+197)
	MAKE_LITERAL_STRING (1)
db 99
	MAKE_LITERAL_SYMBOL (const_tbl+216)
	MAKE_LITERAL_STRING (1)
db 100
	MAKE_LITERAL_SYMBOL (const_tbl+235)
	MAKE_LITERAL_STRING (1)
db 101
	MAKE_LITERAL_SYMBOL (const_tbl+254)
	MAKE_LITERAL_STRING (1)
db 102
	MAKE_LITERAL_SYMBOL (const_tbl+273)
	MAKE_LITERAL_STRING (1)
db 103
	MAKE_LITERAL_SYMBOL (const_tbl+292)
	MAKE_LITERAL_STRING (1)
db 104
	MAKE_LITERAL_SYMBOL (const_tbl+311)
	MAKE_LITERAL_STRING (1)
db 105
	MAKE_LITERAL_SYMBOL (const_tbl+330)
	MAKE_LITERAL_STRING (1)
db 106
	MAKE_LITERAL_SYMBOL (const_tbl+349)
	MAKE_LITERAL_PAIR (const_tbl+359, const_tbl+1)
	MAKE_LITERAL_PAIR (const_tbl+340, const_tbl+368)
	MAKE_LITERAL_PAIR (const_tbl+321, const_tbl+385)
	MAKE_LITERAL_PAIR (const_tbl+302, const_tbl+402)
	MAKE_LITERAL_PAIR (const_tbl+283, const_tbl+419)
	MAKE_LITERAL_PAIR (const_tbl+264, const_tbl+436)
	MAKE_LITERAL_PAIR (const_tbl+245, const_tbl+453)
	MAKE_LITERAL_PAIR (const_tbl+226, const_tbl+470)
	MAKE_LITERAL_PAIR (const_tbl+207, const_tbl+487)
	MAKE_LITERAL_PAIR (const_tbl+188, const_tbl+504)
fvar_tbl:
  dq T_UNDEFINED
	dq T_UNDEFINED
	dq T_UNDEFINED
...
love:
    ...
    ret
		doneclousure1:
    mov qword [fvar_tbl + WORD_SIZE*51], rax;setting fvar:set-box!
    ...
    ret
		doneclousure2:
    mov qword [fvar_tbl + WORD_SIZE*50], rax;setting fvar:unbox
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    ret
		doneclousure3:
    mov qword [fvar_tbl + WORD_SIZE*49], rax;setting fvar:box
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    ret
		doneclousure4:
    mov qword [fvar_tbl + WORD_SIZE*36], rax;setting fvar:list
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    push rax
    push qword 1
    mov rax, qword [fvar_tbl + WORD_SIZE*49];get fvar:box
		IS_UNDEF sym49
    violation_check rax, T_CLOSURE
      REST_APPLIC
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*47], rax;setting fvar:append
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void

		
    push SOB_NIL_ADDRESS
			mov rax, qword [fvar_tbl + WORD_SIZE*47];get fvar:append
		IS_UNDEF sym47
    push rax
			mov rax, qword [fvar_tbl + WORD_SIZE*36];get fvar:list
		IS_UNDEF sym36
    push rax
			mov rax, qword [fvar_tbl + WORD_SIZE*2];get fvar:cdr
		IS_UNDEF sym2
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*48], rax;setting fvar:reverse
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    push rax
		...
		IS_UNDEF sym47
    push rax
			mov rax, qword [fvar_tbl + WORD_SIZE*48];get fvar:reverse
		IS_UNDEF sym48
    push rax
			mov rax, qword [fvar_tbl + WORD_SIZE*10];get fvar:null?
		IS_UNDEF sym10
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*46], rax;setting fvar:zero?
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    mov rax, qword [fvar_tbl + WORD_SIZE*45];get fvar:list?
		IS_UNDEF sym45
    violation_check rax, T_CLOSURE
    TP_SHIFT_FRAME 1
    REST_APPLICTP
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*45], rax;setting fvar:list?
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*39], rax;setting fvar:length
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void

		
    push SOB_NIL_ADDRESS
			mov rax, qword [fvar_tbl + WORD_SIZE*39];get fvar:length
		IS_UNDEF sym39
    push rax
			mov rax, qword [fvar_tbl + WORD_SIZE*33];get fvar:=
		IS_UNDEF sym33
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*44], rax;setting fvar:number?
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    push rax
    push qword 2
    mov rax, qword [fvar_tbl + WORD_SIZE*43];get fvar:map
		IS_UNDEF sym43
    violation_check rax, T_CLOSURE
      REST_APPLIC
    push rax
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*43], rax;setting fvar:map
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*41], rax;setting fvar:list->vector
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*42], rax;setting fvar:vector->list
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void

		
    push SOB_NIL_ADDRESS
			mov rax, qword [fvar_tbl + WORD_SIZE*41];get fvar:list->vector
		IS_UNDEF sym41
    push rax
    push qword 1
    EXTEND_VEC rax, rbx
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*40], rax;setting fvar:vector
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*38], rax;setting fvar:>
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    push rax
    push qword 2
    mov rax, qword [fvar_tbl + WORD_SIZE*35];get fvar:equal?
		IS_UNDEF sym35
    violation_check rax, T_CLOSURE
      REST_APPLIC
    cmp rax, SOB_FALSE_ADDRESS
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*35], rax;setting fvar:equal?
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void

		
    push SOB_NIL_ADDRESS
			mov rax, const_tbl + 521
    push rax
			EXTEND_VEC rax, rbx
    push rax
    COPY_PARAM rbx
    ...
    push qword 1
    push SOB_NIL_ADDRESS
			GET_BOUND rax,0,0;get bound:p1
    push rax
    push qword 1
    push SOB_NIL_ADDRESS
			GET_BOUND rax,0,0;get bound:p1
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*34], rax;setting fvar:test
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void

		push SOB_NIL_ADDRESS
    push qword 0
    mov rax, qword [fvar_tbl + WORD_SIZE*34];get fvar:test
		IS_UNDEF sym34
    violation_check rax, T_CLOSURE
      REST_APPLIC
		call write_sob_if_not_void
