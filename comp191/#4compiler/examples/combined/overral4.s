...
const_tbl:
  ...
  db 116,104,105,115,32,115,104,111,117,108,100,32,98,101,32,97,110,32,101,114,114,111,114,44,32,98,117,116,32,121,111,117,32,100,111,110,39,116,32,115,117,112,112,111,114,116,32,101,120,99,101,112,116,105,111,110,115
	...
	MAKE_LITERAL_CHAR (0)
	MAKE_LITERAL_STRING (7)
    
  db 118,101,99,116,111,114,115

	MAKE_LITERAL_VECTOR (0)
	MAKE_LITERAL_INT (5)
	MAKE_LITERAL_VECTOR (1)
  dq const_tbl+203
	MAKE_LITERAL_INT (4)
	MAKE_LITERAL_VECTOR (2)
  dq const_tbl+203,const_tbl+229
	MAKE_LITERAL_INT (6)
	MAKE_LITERAL_VECTOR (3)
  dq const_tbl+229,const_tbl+203,const_tbl+263
	MAKE_LITERAL_INT (7)
	MAKE_LITERAL_INT (8)
	MAKE_LITERAL_INT (9)
	MAKE_LITERAL_VECTOR (5)
  dq const_tbl+203,const_tbl+263,const_tbl+305,const_tbl+314,const_tbl+323
	MAKE_LITERAL_STRING (5)
    
  db 113,117,97,115,105
  ...
  db 107
	...
	MAKE_LITERAL_SYMBOL (const_tbl+404)
	MAKE_LITERAL_STRING (5)
    
  db 113,117,111,116,101

	MAKE_LITERAL_SYMBOL (const_tbl+423)
	MAKE_LITERAL_PAIR (const_tbl+414, const_tbl+1)
	MAKE_LITERAL_PAIR (const_tbl+437, const_tbl+446)
	MAKE_LITERAL_PAIR (const_tbl+463, const_tbl+1)
	MAKE_LITERAL_PAIR (const_tbl+395, const_tbl+480)
	MAKE_LITERAL_PAIR (const_tbl+101, const_tbl+497)
	MAKE_LITERAL_INT (3)
	MAKE_LITERAL_PAIR (const_tbl+531, const_tbl+1)
	MAKE_LITERAL_PAIR (const_tbl+395, const_tbl+540)
	MAKE_LITERAL_PAIR (const_tbl+101, const_tbl+557)
	MAKE_LITERAL_PAIR (const_tbl+229, const_tbl+1)
	MAKE_LITERAL_PAIR (const_tbl+305, const_tbl+1)
	MAKE_LITERAL_PAIR (const_tbl+263, const_tbl+608)
	MAKE_LITERAL_PAIR (const_tbl+203, const_tbl+625)
  ...
  db 115,116,114,105,110,103
	...
	MAKE_LITERAL_STRING (3)
    
  db 102,111,114

	MAKE_LITERAL_STRING (6)
    
  db 102,105,110,105,115,104

	MAKE_LITERAL_SYMBOL (const_tbl+705)
	MAKE_LITERAL_FLOAT (4.5)
	MAKE_LITERAL_STRING (4)
    
  db 99,111,110,115

	MAKE_LITERAL_SYMBOL (const_tbl+738)
	MAKE_LITERAL_STRING (5)
    
  db 110,117,108,108,63

	MAKE_LITERAL_SYMBOL (const_tbl+760)
	MAKE_LITERAL_STRING (5)
    
  db 112,97,105,114,63

	MAKE_LITERAL_SYMBOL (const_tbl+783)
	MAKE_LITERAL_STRING (1)
    
  db 97

	MAKE_LITERAL_SYMBOL (const_tbl+806)
	MAKE_LITERAL_STRING (1)
    
  db 98

	MAKE_LITERAL_SYMBOL (const_tbl+825)
	MAKE_LITERAL_PAIR (const_tbl+835, const_tbl+1)
	MAKE_LITERAL_PAIR (const_tbl+816, const_tbl+844)
	MAKE_LITERAL_STRING (1)
    
  db 99

	MAKE_LITERAL_SYMBOL (const_tbl+878)
	MAKE_LITERAL_INT (100000)
fvar_tbl:
  dq T_UNDEFINED
	dq T_UNDEFINED
	dq T_UNDEFINED
...
love:
    ...
    ret
		doneclousure7:
    mov qword [fvar_tbl + WORD_SIZE*56], rax;setting fvar:list
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*36], rax;setting fvar:append
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    push rax
		...
		IS_UNDEF sym46
    push rax
			mov rax, qword [fvar_tbl + WORD_SIZE*36];get fvar:append
		IS_UNDEF sym36
    push rax
			mov rax, qword [fvar_tbl + WORD_SIZE*56];get fvar:list
		IS_UNDEF sym56
    push rax
			mov rax, qword [fvar_tbl + WORD_SIZE*3];get fvar:cdr
		IS_UNDEF sym3
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*55], rax;setting fvar:reverse
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    push rax
		...
		IS_UNDEF sym36
    push rax
			mov rax, qword [fvar_tbl + WORD_SIZE*55];get fvar:reverse
		IS_UNDEF sym55
    push rax
			mov rax, qword [fvar_tbl + WORD_SIZE*11];get fvar:null?
		IS_UNDEF sym11
    ...
    mov rax, SOB_VOID_ADDRESS
		...
		mov rax, const_tbl + 332
		call write_sob_if_not_void

		mov rax, const_tbl + 381
		call write_sob_if_not_void
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
		...
		mov rax, const_tbl + 514
		call write_sob_if_not_void

		push SOB_NIL_ADDRESS
			mov rax, const_tbl + 642
    push rax
			mov rax, const_tbl + 591
    push rax
			mov rax, const_tbl + 574
    push rax
    push qword 3
    mov rax, qword [fvar_tbl + WORD_SIZE*36];get fvar:append
		IS_UNDEF sym36
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*38], rax;setting fvar:vec
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void

		mov rax, qword [fvar_tbl + WORD_SIZE*38];get fvar:vec
		IS_UNDEF sym38
		call write_sob_if_not_void
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
		...
		mov rax, const_tbl + 676
		call write_sob_if_not_void

		
    push SOB_NIL_ADDRESS
			mov rax, const_tbl + 691
    push rax
			mov rax, const_tbl + 531
    push rax
    push qword 2
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*37], rax;setting fvar:st
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void

		mov rax, qword [fvar_tbl + WORD_SIZE*37];get fvar:st
		IS_UNDEF sym37
		call write_sob_if_not_void
    ...
    push rax
    push qword 3
    mov rax, qword [fvar_tbl + WORD_SIZE*19];get fvar:string-set!
		IS_UNDEF sym19
    violation_check rax, T_CLOSURE
      REST_APPLIC
		call write_sob_if_not_void
    ...
    mov rax, qword [fvar_tbl + WORD_SIZE*35];get fvar:foo
		IS_UNDEF sym35
    violation_check rax, T_CLOSURE
    TP_SHIFT_FRAME 1
    REST_APPLICTP
    ...
    ret
		doneclousure90:
    mov qword [fvar_tbl + WORD_SIZE*35], rax;setting fvar:foo
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void

		push SOB_NIL_ADDRESS
			mov rax, const_tbl + 729
    push rax
			mov rax, const_tbl + 395
    push rax
    push qword 2
    ...
    mov rax, const_tbl + 751
    mov qword [fvar_tbl + WORD_SIZE*4], rax;setting fvar:cons
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void

		
    mov rax, const_tbl + 774
    mov qword [fvar_tbl + WORD_SIZE*11], rax;setting fvar:null?
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void

		
    mov rax, const_tbl + 797
    mov qword [fvar_tbl + WORD_SIZE*10], rax;setting fvar:pair?
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
