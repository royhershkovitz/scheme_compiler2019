...
love:
    ...
    ret
		doneclousure1:
    mov qword [fvar_tbl + WORD_SIZE*49], rax;setting fvar:set-box!
    ...
    ret
		doneclousure2:
    mov qword [fvar_tbl + WORD_SIZE*48], rax;setting fvar:unbox
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    ret
		doneclousure3:
    mov qword [fvar_tbl + WORD_SIZE*47], rax;setting fvar:box
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*46], rax;setting fvar:append
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*45], rax;setting fvar:zero?
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    ret
		doneclousure14:
    mov qword [fvar_tbl + WORD_SIZE*44], rax;setting fvar:list
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    leave
    ret
		doneclousure56:;seq ret;seq ret
    leave
    ret
		doneclousure54:
    violation_check rax, T_CLOSURE
    ...
    leave
    ret
		doneclousure66:;seq ret;seq ret
    leave
    ret
		doneclousure64:
    violation_check rax, T_CLOSURE
    ...
    leave
    ret
		doneclousure70:;seq ret;seq ret
    leave
    ret
		doneclousure68:
    violation_check rax, T_CLOSURE
