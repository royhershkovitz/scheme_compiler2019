...
love:
    ...
    push rax
    push qword 1
    GET_BOUND rax,0,5;get bound:cdr
    violation_check rax, T_CLOSURE
      REST_APPLIC
    push rax
    push qword 1
    GET_BOUND rax,0,1;get bound:reverse
    violation_check rax, T_CLOSURE
      REST_APPLIC
    push rax
    ...
    push SOB_NIL_ADDRESS
			push SOB_NIL_ADDRESS
			mov rax, PVAR(0);get param:reversed_lst
    push rax
    push qword 1
    ...
    push rax
    push qword 1
    GET_BOUND rax,1,3;get bound:pair?
    violation_check rax, T_CLOSURE
      REST_APPLIC
    cmp rax, SOB_FALSE_ADDRESS
    je dif4
    ...
    push rax
    push qword 1
    GET_BOUND rax,1,1;get bound:reverse
    violation_check rax, T_CLOSURE
      REST_APPLIC
    push rax
    push qword 2
    GET_BOUND rax,1,2;get bound:append
    violation_check rax, T_CLOSURE
      REST_APPLIC
    push rax
			push SOB_NIL_ADDRESS
    ...
    GET_BOUND rax,1,0;get bound:apply
    violation_check rax, T_CLOSURE
    TP_SHIFT_FRAME 2
    REST_APPLICTP
    jmp doneif4
    ...
    leave
    ret
		doneclousure60:;seq ret;seq ret
    leave
    ret
		doneclousure58:
    violation_check rax, T_CLOSURE
    ...
    leave
    ret
		doneclousure74:;seq ret;seq ret
    leave
    ret
		doneclousure72:
    violation_check rax, T_CLOSURE
