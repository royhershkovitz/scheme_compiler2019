...
const_tbl:
  ...
  db 116,104,105,115,32,115,104,111,117,108,100,32,98,101,32,97,110,32,101,114,114,111,114,44,32,98,117,116,32,121,111,117,32,100,111,110,39,116,32,115,117,112,112,111,114,116,32,101,120,99,101,112,116,105,111,110,115
	...
	MAKE_LITERAL_CHAR (0)
	MAKE_LITERAL_STRING (9)
    
  db 116,97,110,122,97,110,105,97,10

	MAKE_LITERAL_STRING (0)
...
love:
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*47], rax;setting fvar:zero?
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*36], rax;setting fvar:not
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    push rax
		...
		IS_UNDEF sym2
    push rax
			mov rax, qword [fvar_tbl + WORD_SIZE*36];get fvar:not
		IS_UNDEF sym36
    push rax
			mov rax, qword [fvar_tbl + WORD_SIZE*34];get fvar:=
		IS_UNDEF sym34
    ...
    push SOB_NIL_ADDRESS
			mov rax, qword [fvar_tbl + WORD_SIZE*39];get fvar:>
		IS_UNDEF sym39
    push rax
    push qword 1
    EXTEND_VEC rax, rbx
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*38], rax;setting fvar:positive?
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*37], rax;setting fvar:negative?
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
