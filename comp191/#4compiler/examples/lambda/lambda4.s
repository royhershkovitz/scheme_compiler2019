...
jmp sympass0
  ...
  jmp sympass51
	...
	sympass51:
	mov qword[symbols_tbl+51*WORD_SIZE], sym51
...
love:
    ...
    ret
		doneclousure2:
    mov qword [fvar_tbl + WORD_SIZE*51], rax;setting fvar:set-unbox
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov qword [fvar_tbl + WORD_SIZE*49], rax;setting fvar:zero?
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    ret
		doneclousure13:
    mov qword [fvar_tbl + WORD_SIZE*48], rax;setting fvar:list
    mov rax, SOB_VOID_ADDRESS
		call write_sob_if_not_void
    ...
    violation_check rax, T_CLOSURE
      REST_APPLIC
    mov PVAR(0), rax;setting param:x
    mov rax, SOB_VOID_ADDRESS
		push SOB_NIL_ADDRESS
			mov rax, PVAR(1);get param:y
    push rax
