...
love:
    ...
    push rax
    push qword 1
    mov rax, [fvar_tbl + WORD_SIZE*0];get fvar:box
		IS_UNDEF
    ...
    violation_check rax, T_CLOSURE
    rest_applic
    mov PVAR(1), rax;setting param:y
    mov rax, SOB_VOID_ADDRESS
		push SOB_NIL_ADDRESS
			push SOB_NIL_ADDRESS
    ...
    push rax
    push qword 1
    mov rax, [fvar_tbl + WORD_SIZE*4];get fvar:car
		IS_UNDEF
    violation_check rax, T_CLOSURE
    rest_applic
    push rax
    push qword 2
    mov rax, [fvar_tbl + WORD_SIZE*31];get fvar:+
		IS_UNDEF
    violation_check rax, T_CLOSURE
    rest_applic
    push rax
    ...
    push rax
    push qword 2
    mov rax, [fvar_tbl + WORD_SIZE*7];get fvar:set-car!
		IS_UNDEF
    violation_check rax, T_CLOSURE
    rest_applic
		push SOB_NIL_ADDRESS
...
push SOB_NIL_ADDRESS
    ...
    leave
    ret
		doneclousure5:;seq ret
    leave
    ret
		doneclousure4:;seq ret
    leave
    ret
		doneclousure3:;seq ret
    leave
    ret
		doneclousure2:;seq ret;seq ret
    leave
    ret
		doneclousure1:
    violation_check rax, T_CLOSURE
